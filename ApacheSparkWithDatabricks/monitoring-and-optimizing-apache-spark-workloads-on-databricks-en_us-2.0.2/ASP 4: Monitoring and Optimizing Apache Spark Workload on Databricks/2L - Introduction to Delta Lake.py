...
# MAGIC %sql
# MAGIC --Check the history of changes to the Delta table
...
# MAGIC %sql
# MAGIC --Update the account_balance for customers in the BUILDING market segment
# MAGIC --1. Increase their account_balance by 10%
# MAGIC --2. Delete customers with a negative account balance
...
# MAGIC %sql
# MAGIC --Display a sample of records from that version, Choose a version from the history (for example, version 1)
...
# MAGIC %sql
# MAGIC --Count the records from that version, Choose a version from the history (for example, version 1)
# MAGIC
...
# MAGIC %sql
# MAGIC --Restore the delta_customers table to a previous version (e.g. Version 1)

...
try:    current_partitions = flights_df.rdd.getNumPartitions()
except Exception:
    current_partitions = 'Not available in shared clusters'
...
current_partitions = filtered_flights_df.rdd.getNumPartitions() if hasattr(filtered_flights_df, 'rdd') else None
print(f"Current number of partitions: {current_partitions}")

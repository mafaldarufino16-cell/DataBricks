...
setattr(DA, 'user_hive_schema', 'mafalda_rufino')
...
create_movies_table_in_hive = spark.sql(f"""
                CREATE OR REPLACE TABLE hive_metastore.mafalda_rufino.movies 
                AS 
                SELECT * FROM databrickstheloop.movies_samples.movies_bronze
                LIMIT 1000
                """)

...
# MAGIC %sql
# MAGIC USE CATALOG databrickstheloop;
...
# Output file path
output_path = Path(f'/Volumes/dbacademy/mafalda_rufino/mafalda_rufino/json_demo_files/lab_kafka_events.json')
...
username_cleaned = DA.username.replace('.', '_')
# Output file path
output_path = Path(f'/Volumes/dbacademy/mafalda_rufino/mafalda_rufino/json_demo_files/lab_kafka_events_challenge.json')
...
# MAGIC         '/Volumes/dbacademy/mafalda_rufino/mafalda_rufino/json_demo_files/lab_kafka_events_challenge.json',
# MAGIC         format => "json", 
# MAGIC         schema => '''
# MAGIC           key STRING, 

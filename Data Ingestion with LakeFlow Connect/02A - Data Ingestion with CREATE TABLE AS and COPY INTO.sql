...
-- MAGIC %md
-- MAGIC Run the cell below to view your default catalog and schema. Notice that your default catalog is **databrickstheloop** and your default schema is your unique **labuser** schema.
-- MAGIC
...
-- MAGIC  .saveAsTable(f"databrickstheloop.{DA.schema_name}.historical_users_bronze_python")
-- MAGIC )
-- MAGIC
-- MAGIC
-- MAGIC ## 3. Read and view the table
-- MAGIC users_bronze_table = spark.table(f"databrickstheloop.{DA.schema_name}.historical_users_bronze_python")
